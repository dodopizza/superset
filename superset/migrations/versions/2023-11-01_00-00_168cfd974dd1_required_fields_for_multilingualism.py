...
def upgrade():
    ...
    op.add_column(
        "sql_metrics", sa.Column("verbose_name_2nd_lang", sa.Text(), nullable=True)
    )
    op.add_column(
        "sql_metrics", sa.Column("description_2nd_lang", sa.Text(), nullable=True)
    )

    op.add_column(
        "table_columns", sa.Column("verbose_name_2nd_lang", sa.Text(), nullable=True)
    )
    op.add_column(
        "table_columns", sa.Column("description_2nd_lang", sa.Text(), nullable=True)
    )
