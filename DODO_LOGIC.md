...
Расширенная версия пузырьковых диаграмм для визуализации многомерных данных, где размер и цвет пузырьков могут отражать дополнительные измерения. Добавлена возможность настройки минимального размера пузырька (`minBubbleSize`), что гарантирует видимость даже самых маленьких значений.
...
- Гарантированная видимость всех данных благодаря настройке минимального размера пузырька
...
**Расширенные форматы данных и настройки отображения**

Дополнительные форматы для отображения данных, включая специальный формат для длительности (часы:минуты:секунды). Добавлены расширенные настройки отображения для визуализаций, такие как минимальный размер пузырька в пузырьковых диаграммах.
...
- Гарантированная видимость всех данных на диаграммах независимо от их масштаба
