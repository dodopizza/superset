...
const ru = {
  ...
  locale_data: {
    superset: {
      ...
      Rebuild: ['Обновить'],
      'Create filter set': ['Создать набор фильтров'],
      'Filters (%d)': ['Фильтры (%d)'],
      None: ['Пусто'],
      ...
      'Export to Excel': ['Скачать Excel файл'],
      ...
      'Select date (until included)': ['Выберите дату (включая конец)'],
      'END (INCLUSIVE)': ['КОНЕЦ (ВКЛЮЧИТЕЛЬНО)'],
      'End date included to time range': ['Дата окончания включена в диапазон'],
      ...
      'No global filters are currently added': [
        'В данный момент глобальные фильтры не добавлены',
      ],
      'Waiting on database...': ['Ожидаем базу данных...'],
      'Waiting on %s': ['Ожидаем %s'],
      'Remove invalid filters': ['Удалить недействующие фильтры'],
      'Applied filters (%s)': ['Применены фильтры (%s)'],
      'Applied filters (%d)': ['Применены фильтры (%d)'],
      'Applied cross-filters (%d)': ['Применены кросс-фильтры (%d)'],
      'Filter type': ['Тип фильтра'],
      Scope: ['Область применения'],
      'Dependent on': ['Зависит от'],
      'Select filter': ['Фильтр выбора'],
      'Select by id filter': ['Фильтр по ID'],
      'Select with translation': ['Фильтр выбора с переводом'],
      'Select by id with translation': ['Фильтр по ID с переводом'],
      'Time filter': ['Фильтр по времени'],
      ...
      'Filter only displays values relevant to selections made in other filters.':
        [
          'Фильтр отображает только значения, относящиеся к выборам, сделанным в других фильтрах.',
        ],
      ...
      'Return to specific datetime.': ['Вернуться к конкретной дате.'],
      Syntax: ['Синтаксис'],
      Example: ['Пример'],
      'Moves the given set of dates by a specified interval.': [
        'Перемещает заданный набор дат с указанным интервалом.',
      ],
      ...
      'Get the last date by the date unit.': [
        'Получить последнюю дату от подразделения даты.',
      ],
      'Get the specify date for the holiday': [
        'Получить дату указания на праздник',
      ],
